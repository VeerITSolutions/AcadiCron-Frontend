...
export const fetchIteamStore = async (page?: any, perPage?: any, type?: any, selectedSearchType?: any) => {
...
export const createIteamStore = async (data: any): Promise<any> => {
  try {
...
export const deleteIteamStore = async (id: number) => {
  const response = await apiClient.delete(`/item-store/${id}`);
  return response.data;
};

// Edit a student category by ID
export const editIteamStore = async (id: number, data: any) => {
