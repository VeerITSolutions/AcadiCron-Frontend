...
"
  ...
  <div className="border-b border-stroke px-4.5 py-4 dark:border-strokedark dark:bg-boxdark dark:drop-shadow-none flex justify-between items-center">
    {/* Title */}
    <h3 className="font-medium text-black dark:text-white">
      {editing ? "Edit Leave" : "Collect Fees"}
    </h3>
    <svg onClick={handleClose} xmlns="http://www.w3.org/2000/svg" width="20" height="20"fill="none"
 viewBox="0 0 24 24" stroke="currentColor" className="text-black dark:text-white cursor-pointer"
    >
